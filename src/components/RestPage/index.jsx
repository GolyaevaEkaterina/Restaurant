      ...
      <div className="mb-10">
        <div className="relative h-52 w-full rounded-3xl shadow-md mb-2 mt-8">
          <img
            alt=""
            src={rest.image}
            className="h-52 w-full object-cover object-center rounded-3xl"
          />
          <div className="absolute flex inset-0 rounded-3xl container-absolute">
            <div className=" m-8">
              ...
              <div className="flex gap-6">
                ...
                <div
                  onClick={() => setIsOpenInfoContainer(true)}
                  className="cursor-pointer p-2 rounded-xl container-small text-4xl text-zinc-800 h-14 w-14"
                >
            ...
            <InfoContainer
              rest={rest}
              isOpenInfoContainer={isOpenInfoContainer}
              setIsOpenInfoContainer={setIsOpenInfoContainer}
            />
          </div>
        </div>
