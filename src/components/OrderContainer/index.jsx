...
const OrderContainer = ({
  isOpenOrderContainer,
  setIsOpenOrderContainer,
  cartItems,
  setCartItems,
  setTextCart,
  setIsOpenOrderButton,
}) => {
    ...
    <div>
      <div
        className={classNames(
          "flex items-center fixed inset-0 w-screen h-screen bg-white container-order",
          {
      ...
      >
        <form className="m-auto p-8 w-96 rounded-2 bg-white rounded-3xl shadow-md text-start">
          <div
            onClick={() => setIsOpenOrderContainer(false)}
            className="flex gap-2 self-start items-center mb-10 cursor-pointer"
          >
          ...
          <div
            onClick={() => sendOrder()}
            className="cursor-pointer text-center px-2 md:px-10 bg-orange-400 rounded-md mt-6 h-10 text-slate-800 text-xl md:text-2xl font-semibold shadow-md"
          >
      ...
      >
        <div className="relative m-auto p-10 w-96 rounded-2 bg-white text-xl rounded-3xl shadow-md text-start">
          <button
            onClick={() => setIsOpenAnswerContainer(false)}
